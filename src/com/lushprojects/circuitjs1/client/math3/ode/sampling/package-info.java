 ...
 * {@link com.lushprojects.circuitjs1.client.math3.ode.sampling.StepHandler StepHandler} instance using the
 * {@link com.lushprojects.circuitjs1.client.math3.ode.FirstOrderIntegrator#addStepHandler addStepHandler}
 ...
 * com.lushprojects.circuitjs1.client.math3.ode.sampling.StepHandler StepHandler} interface can be called
 ...
 * com.lushprojects.circuitjs1.client.math3.ode.sampling.StepInterpolator StepInterpolator} object.
 * If regular output is desired (for example in order to write an ephemeris file), then
 * the simpler {@link com.lushprojects.circuitjs1.client.math3.ode.sampling.FixedStepHandler FixedStepHandler}
 * interface can be used. Objects implementing this interface should be wrapped within a
 * {@link com.lushprojects.circuitjs1.client.math3.ode.sampling.StepNormalizer StepNormalizer} instance
 * in order to be registered to the integrator.
 * </p>
 *
 *
 */
package com.lushprojects.circuitjs1.client.math3.ode.sampling;
