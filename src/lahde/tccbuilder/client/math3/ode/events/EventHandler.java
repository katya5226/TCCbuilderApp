...
import lahde.tccbuilder.client.math3.ode.sampling.FixedStepHandler;
...
import lahde.tccbuilder.client.math3.ode.sampling.StepNormalizer;
...
public interface EventHandler  {
   ...
   * otherwise {@link NoBracketingException
   ...
   *   StepHandler#handleStep handleStep}
   ...
   * StepHandler StepHandler} method {@link
   * StepHandler#handleStep(
   * StepInterpolator, boolean)
   ...
   * {@link FixedStepHandler FixedStepHandler}
   ...
   * StepHandler variable step handlers} and
   * to the size of the fixed step for {@link
   * FixedStepHandler fixed step handlers}.</p>
