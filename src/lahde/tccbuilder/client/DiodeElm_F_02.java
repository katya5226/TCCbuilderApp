...
public class DiodeElm_F_02 extends DiodeElm {
    final double DEFINED_LENGTH = 0.02;

    public DiodeElm_F_02(int xx, int yy) {
        super(xx, yy);
    ...
    public DiodeElm_F_02(int xa, int ya, int xb, int yb, int f,
                             StringTokenizer st) {
...
/*                case 12:
    ...
    public void initializeThermalControlElement() {
        ...
        kForward = 6.0;
        kReverse = 2.5;
        setConstProperty(Simulation.Property.DENSITY, 13700.0);
        setConstProperty(Simulation.Property.SPECIFIC_HEAT_CAPACITY, 140.0);
    }
