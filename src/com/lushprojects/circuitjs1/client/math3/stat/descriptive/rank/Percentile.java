 ...
 */
package com.lushprojects.circuitjs1.client.math3.stat.descriptive.rank;
...
import com.lushprojects.circuitjs1.client.math3.stat.descriptive.AbstractUnivariateStatistic;
import com.lushprojects.circuitjs1.client.math3.stat.ranking.NaNStrategy;
import com.lushprojects.circuitjs1.client.math3.util.KthSelector;
import com.lushprojects.circuitjs1.client.math3.util.MathArrays;
import com.lushprojects.circuitjs1.client.math3.util.MathUtils;
import com.lushprojects.circuitjs1.client.math3.util.MedianOf3PivotingStrategy;
import com.lushprojects.circuitjs1.client.math3.util.PivotingStrategyInterface;
    ...
    public enum EstimationType {
        ...
        R_2("R-2") {
            ...
            protected double estimate(final double[] values,
                                      ...
                                      final int length, final KthSelector selector) {
                final double low =
                        super.estimate(values, pivotsHeap, Math.ceil(pos - 0.5), length, selector);
                final double high =
                        super.estimate(values, pivotsHeap,Math.floor(pos + 0.5), length, selector);
                return (low + high) / 2;
            }
