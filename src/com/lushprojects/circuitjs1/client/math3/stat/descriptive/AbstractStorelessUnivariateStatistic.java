...
public abstract class AbstractStorelessUnivariateStatistic
     ...
     * @see com.lushprojects.circuitjs1.client.math3.stat.descriptive.UnivariateStatistic#evaluate(double[])
     */
    @Override
     ...
     * @see com.lushprojects.circuitjs1.client.math3.stat.descriptive.UnivariateStatistic#evaluate(double[], int, int)
     */
    @Override
     ...
     * @throws MathIllegalArgumentException if values is null
     * @see com.lushprojects.circuitjs1.client.math3.stat.descriptive.StorelessUnivariateStatistic#incrementAll(double[])
     */
     ...
     * @throws MathIllegalArgumentException if values is null
     * @see com.lushprojects.circuitjs1.client.math3.stat.descriptive.StorelessUnivariateStatistic#incrementAll(double[], int, int)
     */
