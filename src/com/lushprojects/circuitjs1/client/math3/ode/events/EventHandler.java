...
package com.lushprojects.circuitjs1.client.math3.ode.events;
...
public interface EventHandler  {
    ...
    enum Action {
         ...
         * com.lushprojects.circuitjs1.client.math3.ode.FirstOrderDifferentialEquations#computeDerivatives}
         * method).</p>
         */
        RESET_DERIVATIVES,
   ...
   * otherwise {@link com.lushprojects.circuitjs1.client.math3.exception.NoBracketingException
   ...
   * com.lushprojects.circuitjs1.client.math3.ode.FirstOrderDifferentialEquations
   ...
   *   com.lushprojects.circuitjs1.client.math3.ode.sampling.StepHandler#handleStep handleStep}
   ...
   * com.lushprojects.circuitjs1.client.math3.ode.sampling.StepHandler StepHandler} method {@link
   * com.lushprojects.circuitjs1.client.math3.ode.sampling.StepHandler#handleStep(
   * com.lushprojects.circuitjs1.client.math3.ode.sampling.StepInterpolator, boolean)
   ...
   * com.lushprojects.circuitjs1.client.math3.ode.sampling.StepNormalizer StepNormalizer}
   * does for example), user code called by this method and user
   * code called by step handlers may experience apparently out of order values
   * of the independent time variable. As an example, if the same user object
   * implements both this {@link EventHandler EventHandler} interface and the
   * {@link com.lushprojects.circuitjs1.client.math3.ode.sampling.FixedStepHandler FixedStepHandler}
   ...
   * com.lushprojects.circuitjs1.client.math3.ode.sampling.StepHandler variable step handlers} and
   * to the size of the fixed step for {@link
   * com.lushprojects.circuitjs1.client.math3.ode.sampling.FixedStepHandler fixed step handlers}.</p>
