...
public class SwitchElm_MM_03 extends SwitchElm {
    final double DEFINED_LENGTH = 0.05;

    public SwitchElm_MM_03(int xx, int yy) {
        super(xx, yy);
    ...
    SwitchElm_MM_03(int xx, int yy, boolean mm) {
        super(xx, yy, mm);
    }

    public SwitchElm_MM_03(int xa, int ya, int xb, int yb, int f, StringTokenizer st) {
