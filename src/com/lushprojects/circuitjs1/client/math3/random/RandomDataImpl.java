...
package com.lushprojects.circuitjs1.client.math3.random;

import java.io.Serializable;
import java.util.Collection;

import com.lushprojects.circuitjs1.client.math3.distribution.IntegerDistribution;
import com.lushprojects.circuitjs1.client.math3.distribution.RealDistribution;
import com.lushprojects.circuitjs1.client.math3.exception.MathIllegalArgumentException;
import com.lushprojects.circuitjs1.client.math3.exception.NotANumberException;
import com.lushprojects.circuitjs1.client.math3.exception.NotFiniteNumberException;
...
import com.lushprojects.circuitjs1.client.math3.exception.NumberIsTooLargeException;
...
public class RandomDataImpl implements RandomData, Serializable {
    ...
    /**
     * Generates a random value from the {@link com.lushprojects.circuitjs1.client.math3.distribution.BetaDistribution Beta Distribution}.
    ...
    /**
     * Generates a random value from the {@link com.lushprojects.circuitjs1.client.math3.distribution.BinomialDistribution Binomial Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link com.lushprojects.circuitjs1.client.math3.distribution.CauchyDistribution Cauchy Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link com.lushprojects.circuitjs1.client.math3.distribution.ChiSquaredDistribution ChiSquare Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link com.lushprojects.circuitjs1.client.math3.distribution.FDistribution F Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
     ...
     * {@link com.lushprojects.circuitjs1.client.math3.distribution.GammaDistribution Gamma Distribution}.</p>
     *
    ...
    /**
     * Generates a random value from the {@link com.lushprojects.circuitjs1.client.math3.distribution.HypergeometricDistribution Hypergeometric Distribution}.
    ...
    /**
     * Generates a random value from the {@link com.lushprojects.circuitjs1.client.math3.distribution.PascalDistribution Pascal Distribution}.
     * This implementation uses {@link #nextInversionDeviate(IntegerDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link com.lushprojects.circuitjs1.client.math3.distribution.TDistribution T Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link com.lushprojects.circuitjs1.client.math3.distribution.WeibullDistribution Weibull Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link com.lushprojects.circuitjs1.client.math3.distribution.ZipfDistribution Zipf Distribution}.
     * This implementation uses {@link #nextInversionDeviate(IntegerDistribution) inversion}
     * to generate random values.
     *
