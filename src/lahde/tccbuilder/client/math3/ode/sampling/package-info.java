 ...
 * {@link lahde.tccbuilder.client.math3.ode.sampling.StepHandler StepHandler} instance using the
 * {@link lahde.tccbuilder.client.math3.ode.FirstOrderIntegrator#addStepHandler addStepHandler}
 ...
 * lahde.tccbuilder.client.math3.ode.sampling.StepHandler StepHandler} interface can be called
 ...
 * lahde.tccbuilder.client.math3.ode.sampling.StepInterpolator StepInterpolator} object.
 * If regular output is desired (for example in order to write an ephemeris file), then
 * the simpler {@link lahde.tccbuilder.client.math3.ode.sampling.FixedStepHandler FixedStepHandler}
 * interface can be used. Objects implementing this interface should be wrapped within a
 * {@link lahde.tccbuilder.client.math3.ode.sampling.StepNormalizer StepNormalizer} instance
 * in order to be registered to the integrator.
 * </p>
 *
 *
 */
package lahde.tccbuilder.client.math3.ode.sampling;
