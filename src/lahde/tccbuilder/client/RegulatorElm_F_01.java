...
public class RegulatorElm_F_01 extends RegulatorElm {

    final double DEFINED_LENGTH = 0.053;

    public RegulatorElm_F_01(int xx, int yy) {
        super(xx, yy);
    ...
    // RegulatorElm_F_01(int xx, int yy, boolean mm) {
    //     super(xx, yy, mm);
    // }

    public RegulatorElm_F_01(int xa, int ya, int xb, int yb, int f, StringTokenizer st) {
