 ...
 * lahde.tccbuilder.client.math3.ode.sampling.StepInterpolator StepInterpolator}
 ...
 * the {@link lahde.tccbuilder.client.math3.ode.FirstOrderDifferentialEquations
 ...
 * {@link lahde.tccbuilder.client.math3.ode.FirstOrderIntegrator
 ...
 * {@link lahde.tccbuilder.client.math3.ode.FirstOrderIntegrator#integrate
 ...
 * lahde.tccbuilder.client.math3.ode.sampling.StepHandler StepHandler} interface or a
 * {@link lahde.tccbuilder.client.math3.ode.sampling.StepNormalizer StepNormalizer}
 * object wrapping a user-specified object implementing the {@link
 * lahde.tccbuilder.client.math3.ode.sampling.FixedStepHandler FixedStepHandler}
 * interface into the integrator before calling the {@link
 * lahde.tccbuilder.client.math3.ode.FirstOrderIntegrator#integrate
 ...
 *
 * <p>
 * {@link lahde.tccbuilder.client.math3.ode.ContinuousOutputModel
 ...
 * lahde.tccbuilder.client.math3.ode.sampling.StepHandler StepHandler} interface are
 * available for general needs ({@link
 * lahde.tccbuilder.client.math3.ode.sampling.DummyStepHandler DummyStepHandler}, {@link
 * lahde.tccbuilder.client.math3.ode.sampling.StepNormalizer StepNormalizer}) and custom
 ...
 * lahde.tccbuilder.client.math3.ode.nonstiff.AdaptiveStepsizeIntegrator
 ...
 * lahde.tccbuilder.client.math3.ode.sampling.StepNormalizer StepNormalizer} class can
 ...
 * <tr><td>{@link lahde.tccbuilder.client.math3.ode.nonstiff.EulerIntegrator Euler}</td><td>1</td></tr>
 * <tr><td>{@link lahde.tccbuilder.client.math3.ode.nonstiff.MidpointIntegrator Midpoint}</td><td>2</td></tr>
 * <tr><td>{@link lahde.tccbuilder.client.math3.ode.nonstiff.ClassicalRungeKuttaIntegrator Classical Runge-Kutta}</td><td>4</td></tr>
 * <tr><td>{@link lahde.tccbuilder.client.math3.ode.nonstiff.GillIntegrator Gill}</td><td>4</td></tr>
 * <tr><td>{@link lahde.tccbuilder.client.math3.ode.nonstiff.ThreeEighthesIntegrator 3/8}</td><td>4</td></tr>
 * <tr><td>{@link lahde.tccbuilder.client.math3.ode.nonstiff.LutherIntegrator Luther}</td><td>6</td></tr>
 * </table>
 * </p>
 *
 * <table border="1" align="center">
 ...
 * <tr><td>{@link lahde.tccbuilder.client.math3.ode.nonstiff.HighamHall54Integrator Higham and Hall}</td><td>5</td><td>4</td></tr>
 * <tr><td>{@link lahde.tccbuilder.client.math3.ode.nonstiff.DormandPrince54Integrator Dormand-Prince 5(4)}</td><td>5</td><td>4</td></tr>
 * <tr><td>{@link lahde.tccbuilder.client.math3.ode.nonstiff.DormandPrince853Integrator Dormand-Prince 8(5,3)}</td><td>8</td><td>5 and 3</td></tr>
 * <tr><td>{@link lahde.tccbuilder.client.math3.ode.nonstiff.GraggBulirschStoerIntegrator Gragg-Bulirsch-Stoer}</td><td>variable (up to 18 by default)</td><td>variable</td></tr>
 * <tr><td>{@link lahde.tccbuilder.client.math3.ode.nonstiff.AdamsBashforthIntegrator Adams-Bashforth}</td><td>variable</td><td>variable</td></tr>
 * <tr><td>{@link lahde.tccbuilder.client.math3.ode.nonstiff.AdamsMoultonIntegrator Adams-Moulton}</td><td>variable</td><td>variable</td></tr>
 * </table>
 * </p>
 *
 * <p>
 * In the table above, the {@link lahde.tccbuilder.client.math3.ode.nonstiff.AdamsBashforthIntegrator
 * Adams-Bashforth} and {@link lahde.tccbuilder.client.math3.ode.nonstiff.AdamsMoultonIntegrator
 ...
 *
 */
package lahde.tccbuilder.client.math3.ode;
